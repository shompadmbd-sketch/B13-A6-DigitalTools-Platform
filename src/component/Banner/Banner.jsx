...
const Banner = () => {
    return (
        <div className="relative min-h-162.5 flex items-center overflow-hidden mt-20 mb-20 sm:mt-15 md:mt-36 lg:mt-10">
            ...
            {/* Desktop UI 100% Original Rakha Hoyeche (230px padding preserved) */}
            <div className="mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-center relative z-10 px-4 md:px-8 lg:px-12 xl:px-[230px] min-[1556px]:px-[250px]">
                ...
                <div className="space-y-4 text-center lg:text-left flex flex-col items-center lg:items-start">
                    ...
                    {/* Desktop e 60px thakbe, Tablet/Mobile e 2-line thakbe */}
                    <h1 className="text-4xl lg:text-[60px] font-extrabold leading-[1.16] text-[#101727]">
                        Supercharge Your
                ...
                {/* Right Image: Margin Adjustment Shudhu Tablet/Mobile er jonno */}
                <div className="relative flex justify-center lg:justify-end mt-0 lg:mt-0 pb-10 lg:pb-0">
